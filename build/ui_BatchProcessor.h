...
public:
    ...
    {
        BatchProcessor->setWindowTitle(QApplication::translate("BatchProcessor", "QModBus Batch Processor", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("BatchProcessor", "Interval (in seconds)", 0, QApplication::UnicodeUTF8));
        label_5->setText(QApplication::translate("BatchProcessor", "Function code", 0, QApplication::UnicodeUTF8));
        functionCode->clear();
        functionCode->insertItems(0, QStringList()
         << QApplication::translate("BatchProcessor", "Read Coils (0x01)", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("BatchProcessor", "Read Discrete Inputs (0x02)", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("BatchProcessor", "Read Holding Registers (0x03)", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("BatchProcessor", "Read Input Registers (0x04)", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("BatchProcessor", "Write Single Coil (0x05)", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("BatchProcessor", "Write Single Register (0x06)", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("BatchProcessor", "Write Multiple Coils (0x0f)", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("BatchProcessor", "Write Multiple Registers (0x10)", 0, QApplication::UnicodeUTF8)
        );
        label_4->setText(QApplication::translate("BatchProcessor", "Output file", 0, QApplication::UnicodeUTF8));
        openOutputFileButton->setText(QApplication::translate("BatchProcessor", "...", 0, QApplication::UnicodeUTF8));
        label_6->setText(QApplication::translate("BatchProcessor", "IDs && registers", 0, QApplication::UnicodeUTF8));
        startButton->setText(QApplication::translate("BatchProcessor", "Start", 0, QApplication::UnicodeUTF8));
        stopButton->setText(QApplication::translate("BatchProcessor", "Stop", 0, QApplication::UnicodeUTF8));
        closeButton->setText(QApplication::translate("BatchProcessor", "Close", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
